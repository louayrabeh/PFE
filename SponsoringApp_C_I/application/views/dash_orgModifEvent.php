                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <?php $this->db->where("idEvent",$id);
                                                    $q=$this->db->get("evenement");
                                                    foreach($q->result() as $row){
                                                        ?>
                                                    <form action="<?php echo base_url();?>index.php/event/modifier_event" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick " id="demo1-upload" method="post">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nomEvent" id="nomEvent" type="text" class="form-control" value="<?php echo $row->nomEvent; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="dateDeb" id="dateDeb" class="form-control" value="<?php echo $row->dateDeb; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="dateFin" id="dateFin" class="form-control" value="<?php echo $row->dateFin; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="heureEvent" id="heureEvent" class="form-control" value="<?php echo $row->heureEvent; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="descriptionEvent" id="descriptionEvent" class="form-control"><?php echo $row->descriptionEvent; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" name="lieuEvent" id="lieuEvent" class="form-control" value="<?php echo $row->lieuEvent; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="budgetEvent" id="budgetEvent" class="form-control" value="<?php echo $row->budget; ?>">
                                                                </div>
                                                                <div class="radio">
                                                                    <label><input type="radio" name="isfree" checked value=0>Gratuit</label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label><input type="radio" name="isfree" value=1>Payant</label>
                                                                </div>
                                                                <div class="form-group">                          
                                                                    <select name="categEvent" id="cat" class="form-control" aria-placeholder="Prefered language">
                                                                        <option value="">Selectionner catégorie</option>
                                                                    <?php
                                                                        foreach($cat as $row1)
                                                                        {
                                                                        ?>
                                                                        <option value="<?php echo $row1->idCateg; ?>" ><?php echo $row1->libCateg; ?></option>;
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="souscategEvent" id="sous" class="form-control" aria-placeholder="Prefered language">
                                                                    <option value="">Selectionner sous catégorie</option>
                                                                    </select>                                       
                                                                </div>
                                                                <div class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom">
                                                                    <h5>Choisir logo</h5>
                                                                        <input type="file" name="image_file" id="image_file" class="btn image" multiple>
                                                                    </div>                                        
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input type="hidden" name="hidbutt" id="hidbutt" value="<?php echo $id; ?>" class="btn btn-info"/>  
                                                                    <button type="submit" class="subButt btn btn-primary waves-effect waves-light">Modifier</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
