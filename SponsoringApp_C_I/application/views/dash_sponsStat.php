              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <h4 class="m-0 font-weight-bold" style='color:#9c27b0'>Evénements qui m'intéressent par mois</h4>
                            <div id="chart">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <h4 class="m-0 font-weight-bold" style='color:#9c27b0'>Packs choisis</h4>
                            <div class="breadcome-list packs" style="height:;width:500px">
                            </div>
                        </div>
                        <div class="single-pro-review-area mt-t-30 mg-b-15 evs">
                        <h4 class="m-0 font-weight-bold" style='color:#9c27b0'>Demandes</h4>
                ...
                <div class="single-pro-review-area mt-t-30 mg-b-15 evs">
                  <h4 class="m-0 font-weight-bold" style='color:#9c27b0'>Evénements que je souhaite les sponsorisés</h4>
                    <div class="events1">
                    </div>
                </div>
            </div>
...
$s=implode(",",$temp);
$query = "SELECT * FROM evenement where idEvent in (".$s.")";
$data=$this->db->query($query);
//$this->db->where_in('idEvent', $temp);
$query = $this->db->get('evenement');
$chart_data = '';
foreach($data->result() as $row)
{
  
  $this->db->like("dateDeb",$row->dateDeb,"both");
  $query1 = $this->db->get('evenement');
  $chart_data .= "{ date:'".$row->dateDeb."', nombre:".$query1->num_rows()."}, ";
}
