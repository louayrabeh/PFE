                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Créer événement</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="<?php echo base_url();?>index.php/org/ajouterEvent" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick " id="demo1-upload" method="post">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nomEvent" type="text" class="form-control"placeholder="Nom de l'événement">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="dateDeb" class="form-control" placeholder="Date début">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="dateFin" class="form-control" placeholder="Date fin">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="heureEvent" class="form-control" placeholder="Heure">
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="descriptionEvent" class="form-control" placeholder="Description de l'événement"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" name="lieuEvent" class="form-control" placeholder="Lieu de l'événement">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="budgetEvent"  class="form-control" placeholder="Budget de l'événement">
                                                                </div>
                                                                <div class="radio">
