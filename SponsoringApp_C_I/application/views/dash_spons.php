                                ...
                                <ul class="mobile-menu-nav">
                                    <li><a data-toggle="collapse" data-target="#Charts" href="#">Dashboard <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul class="collapse dropdown-header-top">
                                            <li>
                                                <a href="<?php echo base_url();?>index.php/welcome/dash_spons" aria-expanded="false">
                                                    <span class="fa fa-desktop"></span>
                                            ...
                                            <li><a href="<?php echo base_url(); ?>index.php/welcome/dash_sponsStat">Statistiques</a></li>
                                            <li><a href="<?php echo base_url(); ?>index.php/welcome/dash_sponsDemande">Demandes <sup class="countdem" style="color: red"></sup></a></li>
                                        </ul>
                                    </li>
                                        ...
                                        <div class="header-right-info">
                                            ...
                                            <li class="nav-item dropdown">
                                             ...
                                             <li class="nav-item">
                                                ...
                                                <span class="admin-name"><?php echo $row->nomSpons." ".$row->prenomSpons; }
                                                ?></span>
...
<!-- profil content-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <?php $this->db->where("idSpons",$this->session->userdata("idSpons"));
                                                    $q=$this->db->get("sponsor");
                                                    foreach($q->result() as $row){
                                                        ?>
                                                    <form action="<?php echo base_url();?>index.php/sponsor/updateinfo" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick " id="demo1-upload" method="post">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nomSpons" type="text" class="form-control" value="<?php echo $row->nomSpons; ?>" placeholder="Nom">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="prenomSpons" class="form-control" placeholder="Prénom" value="<?php echo $row->prenomSpons; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="organismeSpons" class="form-control" placeholder="Organisme" value="<?php echo $row->organismeSpons; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="telSpons" class="form-control" placeholder="Téléphone" value="<?php echo $row->telSpons; ?>">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" name="adrSpons" value="<?php echo $row->adrSpons; ?>" class="form-control" placeholder="Adresse">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="email" name="emailSpons"  class="form-control" placeholder="email" value="<?php echo $row->emailSpons; ?>">
                                                                </div>
                                                                <div class="form-group">                          
                                                                    <select name="centre" id="cat" class="form-control" aria-placeholder="Prefered language">
                                                                ...
                                                                <div class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom">
                                                                        ...
                                                                        <h6>(CIN, Passeport, Permis de conduire, Registre de commerce, Matricule fiscale)</h6>
                                                                        <input type="file" name="file" class="btn image" multiple>
                                                                    </div>                                        
                                                                </div>
                                                                <div style="text-align:center" data-toggle="modal" data-target="#myModal">
                                                                <img style="width:100px;border-radius:50%" id="<?php echo $row->idSpons; ?>" src="data:image/png;base64,<?php echo $row->pieceSpons; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
												...
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="devit-card-custom">
															<div class="form-group">
																<input type="url" class="form-control" placeholder="http://www.facebook.com">
															</div>
															<div class="form-group">
																<input type="url" class="form-control" placeholder="http://www.twitter.com">
															</div>
															<div class="form-group">
																<input type="url" class="form-control" placeholder="http://www.google-plus.com">
															</div>
															<div class="form-group">
																<input type="url" class="form-control" placeholder="http://www.Linkedin.com">
															</div>
															<button type="submit" class="subButt1 btn btn-primary waves-effect waves-light">Submit</button>
														</div>
													</div>
												</div>
                                            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:600px;background:#fff;overflow: auto;color:#000"><div style="text-align:right;margin-top:2%;margin-right:2%"><i data-dismiss="modal" class="fa fa-times"></i></div>
        <?php
        foreach ($q->result() as $row) {
            echo '<img src="data:image/jpeg;base64,'.$row->pieceSpons.'"style="width: 50%;height: 50%;" class="card hoverable img-thumbnail"/>';
        }
        ?>
    </div>
  </div>
