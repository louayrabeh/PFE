                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Créer pack</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="<?php echo base_url();?>index.php/org/creerPack" id="creerPack" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick " id="demo1-upload" method="post">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nomPack" type="text" class="form-control"placeholder="Nom du pack">
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="descriptionPack" class="form-control" placeholder="Description du pack"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" name="montant" class="form-control" placeholder="Montant du pack">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="audience"  class="form-control" placeholder="Audience">
                                                                </div>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="radio">
                                                                        <label><input type="radio" name="typePack" checked value=0>Service</label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label><input type="radio" name="typePack" value=1>Subvention</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    ...
                                                                    <button type="reset" class="subButt btn btn-primary waves-effect waves-light">retour</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
...
function load_unseen_notification(view = '')
 ...
 $(document).ready(function(){
    $(".subButt").click(function(){
        ...
        var typePack=$("#typePack").val();
        $.ajax({
          url:'<?php echo base_url(); ?>index.php/org/creerPack',
          method:'POST',
          data:{nomPack:nomPack,descriptionPack:descriptionPack,montant:montant,audience:audience,typePack:typePack},
          success:function(){
            $('#creerPack')[0].reset();
          }
        });
