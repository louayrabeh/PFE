        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (isread==0){
                    ...
                    viewPagerAdapter.addFragment(new ChatFragment(),"Chat "+"("+isread+")");
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                    ...
                    startActivity(new Intent(Activity2.this,firstActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    //finish();
                    return true;
        }
        return false;
